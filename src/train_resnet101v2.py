...
from resnet import ResNet101V2
...
tensorboard_directory   = 'log_files/logs_ResNet101V2'
weight_directory        = home + '/ownCloud/imagine_weights/screw_detector/pretrained_models/weights_ResNet101V2/'
