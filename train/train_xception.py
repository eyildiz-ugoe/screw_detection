...
BATCH_SIZE1    = 8  # try reducing batch size or freeze more layers if your GPU runs out of memory
FREEZE_LAYERS = 0  # freeze the first this many layers for training
NUM_EPOCHS    = 16

tensorboard_directory   = 'log_files/logs_xception'
weight_directory        = home + '/ownCloud/imagine_weights/screw_detector/pretrained_models/weights_xception'
