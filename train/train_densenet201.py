...
tensorboard_directory   = 'log_files/logs_DenseNet201'
weight_directory        = home + '/ownCloud/imagine_weights/screw_detector/pretrained_models/weights_DenseNet201'
...
#model.load_weights('weights_exception/weights.30.h5', by_name=True)
